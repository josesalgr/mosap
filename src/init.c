...
extern SEXP _prioriactions_rcpp_set_objective_min_cost(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_pu_locks(SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_linking_x_le_w(SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_base_variables(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_linking_z_le_w(SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_fix_z_ineligible_by_positive_delta(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_target_conservation(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_target_recovery(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_target_mixed_total(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_set_objective_max_benefit(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_set_objective_min_loss(SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_set_objective_max_profit(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_set_objective_max_net_profit(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_set_objective_max_representation(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _prioriactions_rcpp_add_linear_constraint(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"_prioriactions_rcpp_set_objective_min_cost", (DL_FUNC) &_prioriactions_rcpp_set_objective_min_cost, 7},
  {"_prioriactions_rcpp_add_pu_locks", (DL_FUNC) &_prioriactions_rcpp_add_pu_locks, 4},
  {"_prioriactions_rcpp_add_linking_x_le_w", (DL_FUNC) &_prioriactions_rcpp_add_linking_x_le_w, 4},
  {"_prioriactions_rcpp_add_base_variables", (DL_FUNC) &_prioriactions_rcpp_add_base_variables, 5},
  {"_prioriactions_rcpp_add_linking_z_le_w", (DL_FUNC) &_prioriactions_rcpp_add_linking_z_le_w, 4},
  {"_prioriactions_rcpp_fix_z_ineligible_by_positive_delta", (DL_FUNC) &_prioriactions_rcpp_fix_z_ineligible_by_positive_delta, 5},
  {"_prioriactions_rcpp_add_target_conservation", (DL_FUNC) &_prioriactions_rcpp_add_target_conservation, 7},
  {"_prioriactions_rcpp_add_target_recovery", (DL_FUNC) &_prioriactions_rcpp_add_target_recovery, 6},
  {"_prioriactions_rcpp_add_target_mixed_total", (DL_FUNC) &_prioriactions_rcpp_add_target_mixed_total, 7},
  {"_prioriactions_rcpp_set_objective_max_benefit", (DL_FUNC) &_prioriactions_rcpp_set_objective_max_benefit, 6},
  {"_prioriactions_rcpp_set_objective_min_loss", (DL_FUNC) &_prioriactions_rcpp_set_objective_min_loss, 4},
  {"_prioriactions_rcpp_set_objective_max_profit", (DL_FUNC) &_prioriactions_rcpp_set_objective_max_profit, 6},
  {"_prioriactions_rcpp_set_objective_max_net_profit", (DL_FUNC) &_prioriactions_rcpp_set_objective_max_net_profit, 9},
  {"_prioriactions_rcpp_set_objective_max_representation", (DL_FUNC) &_prioriactions_rcpp_set_objective_max_representation, 5},
  {"_prioriactions_rcpp_add_linear_constraint", (DL_FUNC) &_prioriactions_rcpp_add_linear_constraint, 8},
